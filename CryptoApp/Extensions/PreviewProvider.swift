...
class DeveloperPreview {
    ...
    let stat1 = StatisticsModel(title: "Market Cap", value: "$22.5Bn")
    let stat2 = StatisticsModel(title: "Total Volume", value: "$1.23Tr", percentageChange: 12.5)
    let stat3 = StatisticsModel(title: "Portfolio Volume", value: "$50.4k", percentageChange: -24.8)
